...
def sbutton(msg,x,y,w,h,ic,ac,action= 2):
    mouse = pygame.mouse.get_pos()
    click = pygame.mouse.get_pressed()
    if x+w > mouse[0] > x and y+h > mouse[1] > y:
        pygame.draw.rect(win, ac,(x,y,w,h))
...
def game_intro():
    ...
    while intro:
        ...
        sbutton("One Player",295,250,100,50,GREEN,BGREEN,1)
        sbutton("Two Players",405,250,100,50,GREEN,BGREEN,2)
